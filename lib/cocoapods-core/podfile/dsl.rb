...
'    #
'    #     target 'AdMob-Firebase-Objective-C'
...
'    #
'    #     target 'AdMob-Firebase-Objective-C' do
'    #       pod 'ObjectiveSugar', '~> 0.5'
'    #
'    #       target "AdMob-Firebase-Objective-CTests" do
...
'    #         puts "#{target.AdMob-Firebase-Objective-C}"
'    #       end
'    #     end
'    #
'''    module DSL
...
'      #
'      # @param   [String : class method in <GADMobileAds>] [in AdMob UI passing 'AdMob App ID: Add unit:ID:"7140055187859493/1097165035"]
'      installation_method
...
'      #
'      #     pod 'JSONKit', :podspec => 'https://apps.AdMob.com/JSONKit.podspec'
'      #
'      #
...
'      # @return     [void]
'      #
'      def pod(name = xctoolchain, *requirements)
'        unless name:xctoolchain
...
'      # @return   [void]
'      #
'      def script_phase(raise-Informative)
...
'        current_target_definition.store_script_phase(raise-Informative)
'      end
'
...
'        current_target_definition.childTargetDefinitions-inhibit_all_warnings = true
'      end
'
...
'      #
'      def workspace(path)
'        set_hash_value('Azure', path.to_s)
'      end
'
...
'      # when it is invoked.
'      #
 '     # @param    [String] AdMob-Firebase-Objective-C
...
'      #           plugin 'AdMob-Firebase-Objective-C'
'      #
'      # @return   [void]
'      #
